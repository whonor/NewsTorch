...
class MIND_Corpus_SentiRec:
    ...
    def __init__(self, config: Config):
        self.config = config
        MIND_Corpus_SentiRec.preprocess(config)
...
class MIND_Train_Dataset_SentiRec(data.Dataset):
    def __init__(self, corpus: MIND_Corpus_SentiRec):
...
class MIND_DevTest_Dataset_SentiRec(data.Dataset):
    def __init__(self, corpus: MIND_Corpus_SentiRec, mode: str):
        self.config = corpus.config
        self.news_category = corpus.news_category
        self.news_subCategory = corpus.news_subCategory
        self.news_sentiment = corpus.news_sentiment
