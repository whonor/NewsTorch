...
class Config:
    ...
    def __init__(self):
        ...
        parser.add_argument('--model', type=str, default='SentiDebias', help='Model name: NRMS, LSTUR, TANR, DKN, NAML, NPA, FIM, MINS, CenNewsRec, IPNR, CNE-SUE, LKPNR, SentiDebias, SentiRec')
