...
pip install torchtext==0.16.0 torchmetrics==1.5.2 transformers==4.46.3 peft==0.12.0 wandb==0.21.0 scikit-learn==1.0.2 pandas==2.0.3 scipy==1.10.1 openai==1.88.0 nltk==3.7 networkx==3.1 retrying==1.4.1 polars matplotlib  sentencepiece ultralytics-thop
